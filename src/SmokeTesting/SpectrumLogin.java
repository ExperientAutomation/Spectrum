...
public class SpectrumLogin {
	...
	public void loginTest(String username, String password, String browser) throws MalformedURLException{
		System.out.println("Spectrum " + browser);
		...
		System.out.println("Home page was loaded");
	...
	public Object[][] getData(){
		...
		//row 1
		data[0][0]="sreejakeyans+IEC@gmail.com";
		data[0][1]="Sreejak@1";
		data[0][2]="chrome";

		//row 2
		data[1][0]="sreejakeyans+MSFT@gmail.com";
		data[1][1]="Sreejak@1";
		data[1][2]="firefox";

		//row 3
		data[2][0]="sreejakeyans+MSFT@gmail.com";
		data[2][1]="Sreejak@1";
		data[2][2]="chrome";
		return data;
	}
