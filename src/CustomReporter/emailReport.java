...
//	}
    ...
    try {
        ...
        message.setSubject("Automation Report for Spectrum Concurrency testing");
        //message.setText("PFA");
        ...
        String file = "N:\\QA\\R&DQA\\Selenium\\workspace\\TestNG\\test-output\\emailable-report.html";
        String fileName = "emailable-report.html";
        DataSource source = new FileDataSource(file);
        attachmentPart.setDataHandler(new DataHandler(source));
        attachmentPart.setFileName(fileName);
        String html = "<p>Hi,</p><p>PFA the Automation Test report.</p><p>Thanks,</p><p>Mahesh</p>";
